...
const Register = () => {
    ...
    return (
      ...
      <div  className="bg-white mt-10">
        <div className='border-2 mx-auto  w-[350px] h-[560px] md:h-[680px] mb-6 mt-6 md:w-[500px] p-5
         md:p-10 bg-white bg-opacity-50  hover:shadow-2xl  rounded-md' >
          ...
          <h3 className='text-white text-lg  font-medium'>Full Name</h3>
            ...
            <input className='pl-2 bg-blue-200 rounded-md py-2 w-[300px] md:w-[400px]   text-lg '
          ...
          <form onSubmit={handleSubmit(onSubmit)} className=' w-40 h-80 relative'>
            ...
            <p className=' mb-6 w-[300px] '>Already have an account? <Link className='font-semibold text-purple-800' to="/login">Login</Link></p>
